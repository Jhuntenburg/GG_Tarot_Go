...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, rocks.zipcode.gg_tarot_go.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, rocks.zipcode.gg_tarot_go.repository.UserRepository.USERS_BY_EMAIL_CACHE);
